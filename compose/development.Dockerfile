...
# The Lecture Capture Preferences source will be mounted here as a volume
VOLUME /usr/src/app
...
ENV DJANGO_SETTINGS_MODULE project.settings_developer
ENTRYPOINT ["/tmp/wait-for-it.sh", "preferences-db:5432", "--"]
